...
/**
 * Check whether the {@code java.time.LocalDate} passed to be validated is before or just today.
 *
 * @author sandynz
 */
public class DailyPastOrPresentValidatorForLocalDate implements ConstraintValidator<DailyPastOrPresent, LocalDate> {
